...
model = load_model('F:/models/model_pneum.h5')

model1= load_model('F:/models/model.h5')  

model3= pickle.load(open('F:/models/model.pkl', 'rb')) 
...
model2= load_model('F:/models/model-015.model')  
